...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,699 | 🐛 568 | 🌐 Go | 📅 2026-09-04 - An alternative Go compiler for embedded systems, that supports GBA compilation
...
* [Butano](https://github.com/GValiente/butano) ⭐ 1,758 | 🐛 0 | 🌐 C++ | 📅 2026-08-06 - Modern C++ high level engine for the GBA.
* [rust-console](https://github.com/rust-console/gba) ⭐ 725 | 🐛 7 | 🌐 Rust | 📅 2026-08-13 - GBA programming in Rust, plus tutorial.
...
* [agbabi](https://github.com/felixjones/agbabi) ⭐ 80 | 🐛 3 | 🌐 C | 📅 2024-05-10 - Drop-in application binary interface library (context switching, division, irq, memcpy, sine).
...
* [gba-hpp](https://github.com/felixjones/gba-hpp) ⭐ 30 | 🐛 0 | 🌐 C++ | 📅 2024-04-20 - C++20 header-only library for GBA development.
...
* [SkyEmu](https://github.com/skylersaleh/SkyEmu) ⭐ 1,252 | 🐛 258 | 🌐 C | 📅 2026-06-26 - GB/GBA/NDS Emulator with built in debuggers, REST API for scripting, and high accuracy.
* [MiSTer FPGA implementation](https://github.com/MiSTer-devel/GBA_MiSTer) ⭐ 176 | 🐛 21 | 🌐 VHDL | 📅 2026-07-22 - Needs [MiSTer](https://github.com/MiSTer-devel/Main_MiSTer/wiki) ⭐ 3,284 | 🐛 132 | 🌐 C++ | 📅 2026-08-28 setup to run.
...
* [240p-test-mini](https://github.com/pinobatch/240p-test-mini) ⭐ 291 | 🐛 8 | 🌐 Assembly | 📅 2026-07-09 - video signal tests
...
* [OpenLara](https://github.com/XProger/OpenLara) ⭐ 5,069 | 🐛 167 | 🌐 C | 📅 2026-07-26 - Classic Tomb Raider open-source engine
* [Celeste Classic](https://github.com/JeffRuLz/Celeste-Classic-GBA) ⭐ 398 | 🐛 2 | 🌐 C | 📅 2025-04-09 - 2019 port of Pico8 version of Celeste.
...
* [GBA bare metal code](https://github.com/PeterLemon/GBA) ⭐ 145 | 🐛 1 | 🌐 Assembly | 📅 2021-05-27 - Various experiments by Krom, such as video playback and 3D, written in ARM Assembly
...
* [Pokemon Ruby](https://github.com/pret/pokeruby) ⭐ 985 | 🐛 32 | 🌐 C | 📅 2026-04-09 - C programming language annotation of a Pokemon Ruby disassembly
