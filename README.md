...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,728 | 🐛 555 | 🌐 Go | 📅 2026-09-13 - An alternative Go compiler for embedded systems, that supports GBA compilation
* [gba-toolchain](https://github.com/felixjones/gba-toolchain) ⭐ 140 | 🐛 4 | 🌐 CMake | 📅 2026-04-01 - GNU Arm Embedded Toolchain based alternative to devkitARM.
...
* [Butano](https://github.com/GValiente/butano) ⭐ 1,767 | 🐛 0 | 🌐 C++ | 📅 2026-08-06 - Modern C++ high level engine for the GBA.
...
* [SkyEmu](https://github.com/skylersaleh/SkyEmu) ⭐ 1,260 | 🐛 259 | 🌐 C | 📅 2026-09-11 - GB/GBA/NDS Emulator with built in debuggers, REST API for scripting, and high accuracy.
* [MiSTer FPGA implementation](https://github.com/MiSTer-devel/GBA_MiSTer) ⭐ 176 | 🐛 21 | 🌐 VHDL | 📅 2026-07-22 - Needs [MiSTer](https://github.com/MiSTer-devel/Main_MiSTer/wiki) ⭐ 3,289 | 🐛 137 | 🌐 C++ | 📅 2026-09-13 setup to run.
...
* [OpenLara](https://github.com/XProger/OpenLara) ⭐ 5,086 | 🐛 164 | 🌐 C | 📅 2026-07-26 - Classic Tomb Raider open-source engine
...
* [Pokemon Ruby](https://github.com/pret/pokeruby) ⭐ 987 | 🐛 32 | 🌐 C | 📅 2026-04-09 - C programming language annotation of a Pokemon Ruby disassembly
