...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,702 | 🐛 569 | 🌐 Go | 📅 2026-09-04 - An alternative Go compiler for embedded systems, that supports GBA compilation
...
* [Butano](https://github.com/GValiente/butano) ⭐ 1,761 | 🐛 0 | 🌐 C++ | 📅 2026-08-06 - Modern C++ high level engine for the GBA.
...
* [MiSTer FPGA implementation](https://github.com/MiSTer-devel/GBA_MiSTer) ⭐ 176 | 🐛 21 | 🌐 VHDL | 📅 2026-07-22 - Needs [MiSTer](https://github.com/MiSTer-devel/Main_MiSTer/wiki) ⭐ 3,286 | 🐛 133 | 🌐 C++ | 📅 2026-08-28 setup to run.
