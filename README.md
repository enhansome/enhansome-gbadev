...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,730 | 🐛 553 | 🌐 Go | 📅 2026-09-14 - An alternative Go compiler for embedded systems, that supports GBA compilation
...
* [Butano](https://github.com/GValiente/butano) ⭐ 1,768 | 🐛 0 | 🌐 C++ | 📅 2026-08-06 - Modern C++ high level engine for the GBA.
...
* [SkyEmu](https://github.com/skylersaleh/SkyEmu) ⭐ 1,261 | 🐛 259 | 🌐 C | 📅 2026-09-11 - GB/GBA/NDS Emulator with built in debuggers, REST API for scripting, and high accuracy.
* [MiSTer FPGA implementation](https://github.com/MiSTer-devel/GBA_MiSTer) ⭐ 176 | 🐛 21 | 🌐 VHDL | 📅 2026-07-22 - Needs [MiSTer](https://github.com/MiSTer-devel/Main_MiSTer/wiki) ⭐ 3,290 | 🐛 138 | 🌐 C++ | 📅 2026-09-13 setup to run.
...
* [OpenLara](https://github.com/XProger/OpenLara) ⭐ 5,093 | 🐛 164 | 🌐 C | 📅 2026-07-26 - Classic Tomb Raider open-source engine
