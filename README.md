...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,711 | 🐛 556 | 🌐 Go | 📅 2026-09-09 - An alternative Go compiler for embedded systems, that supports GBA compilation
...
* [Butano](https://github.com/GValiente/butano) ⭐ 1,763 | 🐛 0 | 🌐 C++ | 📅 2026-08-06 - Modern C++ high level engine for the GBA.
...
* [SkyEmu](https://github.com/skylersaleh/SkyEmu) ⭐ 1,253 | 🐛 259 | 🌐 C | 📅 2026-06-26 - GB/GBA/NDS Emulator with built in debuggers, REST API for scripting, and high accuracy.
* [MiSTer FPGA implementation](https://github.com/MiSTer-devel/GBA_MiSTer) ⭐ 176 | 🐛 21 | 🌐 VHDL | 📅 2026-07-22 - Needs [MiSTer](https://github.com/MiSTer-devel/Main_MiSTer/wiki) ⭐ 3,286 | 🐛 135 | 🌐 C++ | 📅 2026-09-07 setup to run.
