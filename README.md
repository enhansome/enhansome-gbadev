...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,726 | 🐛 555 | 🌐 Go | 📅 2026-09-12 - An alternative Go compiler for embedded systems, that supports GBA compilation
...
* [Butano](https://github.com/GValiente/butano) ⭐ 1,766 | 🐛 0 | 🌐 C++ | 📅 2026-08-06 - Modern C++ high level engine for the GBA.
...
* [MiSTer FPGA implementation](https://github.com/MiSTer-devel/GBA_MiSTer) ⭐ 176 | 🐛 21 | 🌐 VHDL | 📅 2026-07-22 - Needs [MiSTer](https://github.com/MiSTer-devel/Main_MiSTer/wiki) ⭐ 3,287 | 🐛 138 | 🌐 C++ | 📅 2026-09-12 setup to run.
...
* [OpenLara](https://github.com/XProger/OpenLara) ⭐ 5,084 | 🐛 164 | 🌐 C | 📅 2026-07-26 - Classic Tomb Raider open-source engine
