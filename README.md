...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,648 | 🐛 568 | 🌐 Go | 📅 2026-08-15 - An alternative Go compiler for embedded systems, that supports GBA compilation
...
* [Butano](https://github.com/GValiente/butano) ⭐ 1,741 | 🐛 0 | 🌐 C++ | 📅 2026-08-06 - Modern C++ high level engine for the GBA.
...
* [MiSTer FPGA implementation](https://github.com/MiSTer-devel/GBA_MiSTer) ⭐ 176 | 🐛 20 | 🌐 VHDL | 📅 2026-07-22 - Needs [MiSTer](https://github.com/MiSTer-devel/Main_MiSTer/wiki) ⭐ 3,268 | 🐛 129 | 🌐 C++ | 📅 2026-08-15 setup to run.
...
* [Celeste Classic](https://github.com/JeffRuLz/Celeste-Classic-GBA) ⭐ 392 | 🐛 2 | 🌐 C | 📅 2025-04-09 - 2019 port of Pico8 version of Celeste.
