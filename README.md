...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,730 | 🐛 552 | 🌐 Go | 📅 2026-09-15 - An alternative Go compiler for embedded systems, that supports GBA compilation
...
* [Butano](https://github.com/GValiente/butano) ⭐ 1,770 | 🐛 0 | 🌐 C++ | 📅 2026-08-06 - Modern C++ high level engine for the GBA.
...
* [SkyEmu](https://github.com/skylersaleh/SkyEmu) ⭐ 1,262 | 🐛 259 | 🌐 C | 📅 2026-09-11 - GB/GBA/NDS Emulator with built in debuggers, REST API for scripting, and high accuracy.
* [MiSTer FPGA implementation](https://github.com/MiSTer-devel/GBA_MiSTer) ⭐ 176 | 🐛 21 | 🌐 VHDL | 📅 2026-07-22 - Needs [MiSTer](https://github.com/MiSTer-devel/Main_MiSTer/wiki) ⭐ 3,289 | 🐛 137 | 🌐 C++ | 📅 2026-09-15 setup to run.
...
* [OpenLara](https://github.com/XProger/OpenLara) ⭐ 5,099 | 🐛 165 | 🌐 C | 📅 2026-07-26 - Classic Tomb Raider open-source engine
