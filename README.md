...
* [TinyGo](https://github.com/tinygo-org/tinygo) ⭐ 17,734 | 🐛 544 | 🌐 Go | 📅 2026-09-17 - An alternative Go compiler for embedded systems, that supports GBA compilation
...
* [MiSTer FPGA implementation](https://github.com/MiSTer-devel/GBA_MiSTer) ⭐ 176 | 🐛 21 | 🌐 VHDL | 📅 2026-07-22 - Needs [MiSTer](https://github.com/MiSTer-devel/Main_MiSTer/wiki) ⭐ 3,290 | 🐛 138 | 🌐 C++ | 📅 2026-09-17 setup to run.
...
* [OpenLara](https://github.com/XProger/OpenLara) ⭐ 5,102 | 🐛 165 | 🌐 C | 📅 2026-07-26 - Classic Tomb Raider open-source engine
